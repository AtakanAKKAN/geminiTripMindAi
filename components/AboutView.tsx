    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-6">
        <div className="w-full max-w-2xl bg-white rounded-3xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="flex items-center gap-3 mb-8">
                <div className="w-12 h-12 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl flex items-center justify-center text-white font-bold text-2xl shadow-lg shadow-emerald-200">T</div>
                <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">TripMind AI</h1>
            </div>
            ...
            <div className="space-y-8">
                ...
                <div className="pt-6 border-t border-gray-100 text-center">
                    <p className="text-gray-400 text-sm">v1.0.0 • Mobile App Release</p>
                </div>
            </div>
        </div>
    </div>
